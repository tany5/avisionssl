...
import { VideocoursedetailsService } from './videocoursedetails.service';
import { ActivatedRoute, Route, Router } from '@angular/router';
import { OwlOptions } from 'ngx-owl-carousel-o';
declare var jQuery: any;
@Component({
  selector: 'app-videocoursedetails',
  templateUrl: './videocoursedetails.component.html',
  styleUrls: ['./videocoursedetails.component.scss']
})

export class VideocoursedetailsComponent implements OnInit{
  [x: string]: any;
...
files: FileList
  ...
  constructor(private videoService: VideocoursedetailsService, private route: ActivatedRoute , private router: Router) {
