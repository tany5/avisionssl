...
@Component({
  selector: 'app-mainfreevideosection',
  templateUrl: './mainfreevideosection.component.html',
  styleUrls: ['./mainfreevideosection.component.scss']
})

@Pipe({
  name: 'striphtml'
})
export class MainfreevideosectionComponent implements OnInit {
